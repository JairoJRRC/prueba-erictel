		                ...
		                <div class=”card-block”>  
		                    <table class="table">
		                       <thead>
								...
								<a href=<?php echo "formulario.php?id=".$row['id'].""; ?> title="Editar datos" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

								<a href=<?php echo "../UserManagement.php?delete=true&id=".$row['id'].""; ?> title="Eliminar" onclick="return confirm(\'Esta seguro de borrar los datos '.$row['name'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
				                           </tr>
				                        </tbody>
										<?php
