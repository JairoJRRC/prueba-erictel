<?php 
	...
	function insertUser(InputForm $input) { 
		...
		$sql = sprintf("insert into usuario_datos(name, last_name, city, email, cellphone, birth_date) values ('%s', '%s', '%s', '%s', %s, %s)", $input->name, $input->lastName, $input->city, $input->email, $input->cellphone, $input->birthDate);
	...
	function editUser(InputForm $input, $id) { 
		...
		$sql = sprintf("UPDATE usuario_datos SET name = '%s', last_name = '%s', city = '%s', email = '%s', cellphone = %s, birth_date = %s WHERE id = %s", $input->name, $input->lastName, $input->city, $input->email, $input->cellphone, $input->birthDate, $id);
